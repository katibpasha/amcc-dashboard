                            ...
                            <div class="col">
                                <div class="my-4">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="pilih-sesi-1" name="radio-sesi" class="custom-control-input">
                                        <label class="custom-control-label text-white" for="pilih-sesi-1">Sesi Siang</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="pilih-sesi-2" name="radio-sesi" class="custom-control-input">
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="row px-3">
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-efektifitas-1" name="radio-efektifitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-efektifitas-1">1</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-efektifitas-2" name="radio-efektifitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-efektifitas-2">2</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-efektifitas-3" name="radio-efektifitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-efektifitas-3">3</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-efektifitas-4" name="radio-efektifitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-efektifitas-4">4</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-efektifitas-5" name="radio-efektifitas" class="custom-control-input">
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="row px-3">
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-penyampaian-1" name="radio-penyampaian" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-penyampaian-1">1</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-penyampaian-2" name="radio-penyampaian" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-penyampaian-2">2</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-penyampaian-3" name="radio-penyampaian" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-penyampaian-3">3</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-penyampaian-4" name="radio-penyampaian" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-penyampaian-4">4</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-penyampaian-5" name="radio-penyampaian" class="custom-control-input">
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="row px-3">
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-suasana-1" name="radio-suasana" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-suasana-1">1</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-suasana-2" name="radio-suasana" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-suasana-2">2</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-suasana-3" name="radio-suasana" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-suasana-3">3</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-suasana-4" name="radio-suasana" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-suasana-4">4</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-suasana-5" name="radio-suasana" class="custom-control-input">
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="row px-3">
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-responsibilitas-1" name="radio-responsibilitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-responsibilitas-1">1</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-responsibilitas-2" name="radio-responsibilitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-responsibilitas-2">2</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-responsibilitas-3" name="radio-responsibilitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-responsibilitas-3">3</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-responsibilitas-4" name="radio-responsibilitas" class="custom-control-input">
                                            <label class="custom-control-label text-white" for="pilih-responsibilitas-4">4</label>
                                        </div>
                                        <div class="col custom-control custom-radio">
                                            <input type="radio" id="pilih-responsibilitas-5" name="radio-responsibilitas" class="custom-control-input">
                                ...
                                <div class="my-4">
                                    ...
                                    <textarea rows="5" class="form-control form-control-alternative" placeholder="Kendala selama pelatihan"></textarea>
                                </div>
                                <div class="my-4">
                                    <p class="text-white">Kritik dan saran buat pelatihan kedepannya lebih baik?</p>
                                    <textarea rows="5" class="form-control form-control-alternative" placeholder="Kritik & Saran"></textarea>
                                </div>
                                <a href="surpel.html" class="btn btn-success my-4">
