<div class="header bg-blue-amcc pb-6">
    <div class="container-fluid">
        <div class="header-body">
            <!-- Card stats -->
            <h6 class="h2 text-white d-inline-block mb-4">Super Admin</h6>
            <div class="row">
                <div class="px-3 mb-4">
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-add-pengurus">
                        <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                        <span class="btn-inner--text">Tambah Super Admin</span>
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <div class="table-responsive">
                        <table id="my-datables" class="table align-items-center table-dark table-flush display">
                            ...
                            <tbody class="list">
                                <?php foreach ($superadmin as $item) : ?>
                                    <tr>
                                        <th scope="row">
                                            <?= $item->nim ?>
                                        </th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Tambah Super Admin</h6>
                ...
                <div class="modal-body">
                    <form role="form" action="<?= site_url('superadmin/add') ?>" method="POST">
                        <div class="form-group mb-3">
                            <div class="input-group input-group-merge input-group-alternative">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="ni ni-circle-08"></i></span>
                                </div>
                                <input class="form-control" placeholder="Nama Super Admin" type="text" name="nama" required>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="input-group input-group-merge input-group-alternative">
